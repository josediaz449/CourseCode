...
*/
public class CarBean extends JComponent implements ChangeListener
{
   private int x;
   private int y;
   private int width;
   ...
   private Color base;
   private Color tires;
   private static JSlider xSlide;
   private static JSlider ySlide;
   ...
   */
   ...
   public static void main(String[] args){
      ...
      xSlide = new JSlider(0,a.getWidth(),carBean.getX());
      ySlide = new JSlider(0,a.getHeight(),carBean.getY());

      xSlide.setPaintTrack(true);
      xSlide.setPaintTicks(true);
      xSlide.setPaintLabels(true);
      xSlide.setMajorTickSpacing(50);
      xSlide.setMinorTickSpacing(5);
      xSlide.addChangeListener(carBean);


      ySlide.setPaintTrack(true);
      ySlide.setPaintTicks(true);
      ySlide.setPaintLabels(true);
      ySlide.setMajorTickSpacing(50);
      ySlide.setMinorTickSpacing(5);
      ySlide.addChangeListener(carBean);
      ySlide.setOrientation(SwingConstants.VERTICAL);
      ySlide.setInverted(true);

      a.add(carBean);
      a.setVisible(true);
      a.add(xSlide,BorderLayout.SOUTH);
      a.setVisible(true);
      a.add(ySlide,BorderLayout.WEST);
      a.setVisible(true);
   }

   @Override
   public void stateChanged(ChangeEvent e) {
      this.setX(xSlide.getValue());
      this.setY(ySlide.getValue());
      a.repaint();
   }
}
